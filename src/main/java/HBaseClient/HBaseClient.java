 ...
 * LICENSE file.
 * modified from com.yahoo.ycsb.db.HBaseClient10
 * with all the time measurements removed
 * if not extends DB, need to add Properties _p and relative methods
 */
...
public class HBaseClient extends com.yahoo.ycsb.DB {
  ...
  public void init() throws DBException {
    ...
    // starts.
    // may need change, table not directly from CoreWorkload???
